package com.example.ys020.layout_ex;
    ...
    public void onWindowFocusChanged(boolean hasFocus)
    {
        ...
        if(hasFocus && drawLine == null)
        {
            //그리기 뷰가 보여질(나타날) 레이아웃 찾기..
             View temp_view =(View) findViewById(R.id.temp_view);
            if(temp_view != null) //그리기 뷰가 보여질 레이아웃이 있으면...
            {
                //그리기 뷰 레이아웃의 넓이와 높이를 찾아서 Rect 변수 생성.
                Rect rect = new Rect(0, 0,
                        temp_view.getMeasuredWidth(), temp_view.getMeasuredHeight());

                //그리기 뷰 초기화..
                drawLine = new DrawLine(this, rect);

                //그리기 뷰를 그리기 뷰 레이아웃에 넣기 -- 이렇게 하면 그리기 뷰가 화면에 보여지게 됨.
                //temp_view.addView(drawLine);
            }
